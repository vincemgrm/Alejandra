...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <?php echo $user['firstname'].' '.$user['lastname'].'`s Credit Details' ?>
      </h1>
      <ol class="breadcrumb">
              ...
              <table id="example1" class="table table-bordered">
                ...
                <tbody>
                  <?php
                    ...
                    try{
                      $stmt = $conn->prepare("SELECT *, credit_details.credit_id AS credit_id FROM credit_details LEFT JOIN users ON users.id=credit_details.credit_id WHERE user_id=:user_id");
