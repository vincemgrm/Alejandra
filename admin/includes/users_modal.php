    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                  ...
                  <span aria-hidden="true"></span></button>
              <h4 class="modal-title"><b>Edit Client's Info</b></h4>
            </div>
            <div class="modal-body">
...
<div class="modal fade" id="new_transaction">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
              
                  <span aria-hidden="true"></span></button>
              <h4 class="modal-title"><b>New Transaction</b></h4>
            </div>
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="new_transaction.php">
            ...
            <div class="modal-footer">
              <button type="button" class="btn btn-default btn-flat pull-left" data-dismiss="modal"><i class="fa fa-close"></i> Close</button>
              <button type="submit" class="btn btn-primary btn-flat" name="new_transaction"><i class="fa fa-plus"></i> Create</button>
              </form>
            </div>
        </div>
    </div>
